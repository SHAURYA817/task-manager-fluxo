...
function Signup() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden flex items-center justify-center px-4 py-6 sm:py-10">
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 border border-white/10 bg-white/[0.03] backdrop-blur-2xl rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-2xl shadow-black/40">
        {/* Left Side */}
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-2xl bg-gradient-to-r from-indigo-500 to-violet-500 py-3 sm:py-4 font-medium hover:scale-[1.01] transition disabled:opacity-60"
              >
                {loading
                  ? "Creating account..."
                  : "Create Account"}
        ...
        {/* Right Side */}
        <div className="hidden lg:flex flex-col justify-between border-l border-white/10 p-8 xl:p-14">
          <div>
            {/* Logo */}
            <Link
              to="/"
