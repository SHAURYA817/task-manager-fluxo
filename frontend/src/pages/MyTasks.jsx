    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
          <div className="border border-white/10 bg-white/[0.03] backdrop-blur-2xl rounded-[28px] p-6 hover:bg-white/[0.05] transition">
              ...
              >
                <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/50 mt-4 leading-relaxed max-w-3xl">
                  ...
                  <div className="flex flex-col gap-3 min-w-[220px]">
                    ...
                    <button
                      ...
                      className="px-5 py-4 rounded-2xl border border-yellow-500/20 bg-yellow-500/10 text-yellow-300 hover:bg-yellow-500/20 transition"
                    >
                      In Progress
                    </button>
                    ...
                    <button
                      ...
                      className="px-5 py-4 rounded-2xl border border-green-500/20 bg-green-500/10 text-green-300 hover:bg-green-500/20 transition"
                    >
                      Done
                    </button>
                  </div>
